...
class Logic(QMainWindow, Ui_MainWindow):
    ...
    def check_valid(self) -> None:
        '''
        This function checks if fields and function imputs are valid and returns an
        error message if needed. If all valid, calls the save function.
        '''
